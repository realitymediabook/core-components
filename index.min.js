import{vueComponents as e}from"https://resources.realitymedia.digital/vue-apps/dist/hubs.js";AFRAME.registerSystem("fader-plus",{schema:{direction:{type:"string",default:"none"},duration:{type:"number",default:200},color:{type:"color",default:"white"}},init(){const e=new THREE.Mesh(new THREE.BoxGeometry,new THREE.MeshBasicMaterial({color:this.data.color,side:THREE.BackSide,opacity:0,transparent:!0,fog:!1}));e.scale.x=e.scale.y=1,e.scale.z=.15,e.matrixNeedsUpdate=!0,e.renderOrder=1,this.el.camera.add(e),this.mesh=e},fadeOut(){return this.beginTransition("out")},fadeIn(){return this.beginTransition("in")},async beginTransition(e){if(this._resolveFinish)throw new Error("Cannot fade while a fade is happening.");return this.el.setAttribute("fader-plus",{direction:e}),new Promise((t=>{this.mesh.material.opacity===("in"==e?0:1)?t():this._resolveFinish=t}))},tick(e,t){const a=this.mesh.material;this.mesh.visible="out"===this.data.direction||0!==a.opacity,this.mesh.visible&&("in"===this.data.direction?a.opacity=Math.max(0,a.opacity-1/this.data.duration*Math.min(t,50)):"out"===this.data.direction&&(a.opacity=Math.min(1,a.opacity+1/this.data.duration*Math.min(t,50))),0!==a.opacity&&1!==a.opacity||("none"!==this.data.direction&&this._resolveFinish&&(this._resolveFinish(),this._resolveFinish=null),this.el.setAttribute("fader-plus",{direction:"none"})))}});const t=new THREE.Vector3,a=new THREE.Vector3;function i(e,t){window.APP.componentRegistry=window.APP.componentRegistry||{},window.APP.componentRegistry[t]=window.APP.componentRegistry[t]||[],window.APP.componentRegistry[t].push(e)}function r(e,t){window.APP.componentRegistry&&window.APP.componentRegistry[t]&&window.APP.componentRegistry[t].splice(window.APP.componentRegistry[t].indexOf(e),1)}function o(e,t){for(;e&&(!e.components||!e.components[t]);)e=e.parentNode;return e}AFRAME.registerComponent("proximity-events",{schema:{radius:{type:"number",default:1},fuzz:{type:"number",default:.1},Yoffset:{type:"number",default:0}},init(){this.inZone=!1,this.camera=this.el.sceneEl.camera},tick(){this.camera.getWorldPosition(t),this.el.object3D.getWorldPosition(a);const e=this.inZone;t.y-=this.data.Yoffset;var i=t.distanceTo(a),r=this.data.radius+(this.inZone?this.data.fuzz:0);this.inZone=i<r,this.inZone&&!e&&this.el.emit("proximityenter"),!this.inZone&&e&&this.el.emit("proximityleave")}});let n=function(e,t){let a=t.position;return 1e6*(Math.floor(a.x/e)+5e5)+(Math.floor(a.z/e)+5e5)},s=[];function l(e){let t=e;for(;t&&t.components&&!t.components["object-region-follower"];)t=t.parentNode;if(t&&t.components&&t.components["object-region-follower"])return t.components["object-region-follower"]}function c(e){s[e]?s[e]++:s[e]=1,console.log("Avatars in region "+e+": "+s[e]),1==s[e]?m(e,!0):console.log("already another avatar in this region, no change")}function h(e){s[e]&&s[e]--,console.log("Avatars left region "+e+": "+s[e]),0==s[e]?m(e,!1):console.log("still another avatar in this region, no change")}function m(e,t){if(!window.APP||!window.APP.componentRegistry)return null;console.log((t?"showing":"hiding")+" all objects in region "+e);const a=window.APP.componentRegistry["object-region-follower"]||[];for(let i=0;i<a.length;i++){const r=a[i];r.region==e&&(console.log((t?"showing ":" hiding")+r.el.className),r.showHide(t))}return null}AFRAME.registerComponent("avatar-region-follower",{schema:{size:{default:10}},init:function(){this.region=n(this.data.size,this.el.object3D),console.log("Avatar: region ",this.region),c(this.region),i(this,"avatar-region-follower")},remove:function(){r(this,"avatar-region-follower"),h(this.region)},tick:function(){let e=n(this.data.size,this.el.object3D);e!=this.region&&(h(this.region),c(e),this.region=e)}}),AFRAME.registerComponent("object-region-follower",{schema:{size:{default:10},dynamic:{default:!0}},init:function(){this.region=n(this.data.size,this.el.object3D),this.showHide=this.showHide.bind(this),this.el.components["media-video"]&&(this.wasPaused=this.el.components["media-video"].data.videoPaused),i(this,"object-region-follower")},remove:function(){r(this,"object-region-follower")},tick:function(){if(!this.data.dynamic)return;this.region=n(this.data.size,this.el.object3D);let e=!!s[this.region];this.el.object3D.visible!=e&&this.showHide(e)},showHide:function(e){this.el.object3D.visible=e,this.el.components["media-video"]&&(e?this.wasPaused!=this.el.components["media-video"].data.videoPaused&&this.el.components["media-video"].togglePlaying():(this.wasPaused=this.el.components["media-video"].data.videoPaused,this.wasPaused||this.el.components["media-video"].togglePlaying()))}}),AFRAME.registerComponent("region-hider",{schema:{size:{default:10}},init:function(){if(!o(this.el,"nav-mesh-helper"))return console.warn("region-hider component must be in the environment scene glb."),void(this.size=0);0==this.data.size&&(this.data.size=10,this.size=this.parseNodeName(this.data.size));let e=document.getElementsByClassName("RoomObjects");this.roomObjects=e.length>0?e[0]:null;this.el.sceneEl.querySelectorAll("[player-info]").forEach((e=>{e.setAttribute("avatar-region-follower",{size:this.size})}));var t=this.el.sceneEl.querySelectorAll(".RoomObjects > [media-loader]");t.forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool], a-scene > [media-loader]")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool]")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),this.sceneLoaded=this.sceneLoaded.bind(this),this.el.sceneEl.addEventListener("environment-scene-loaded",this.sceneLoaded)},isAncestor:function(e,t){for(;t&&t!=e;)t=t.parentNode;return t==e},sceneLoaded:function(){let e=document.getElementById("environment-scene").children[0].children[0];for(let a=0;a<e.length;a++){let i=e[a];if(this.isAncestor(i,this.el))continue;let r=i.className;if("CombinedMesh"===r||"scene-preview-camera"===r)continue;let o=i.components;if(o.waypoint||o.skybox||o["directional-light"]||o["ambient-light"]||o["hemisphere-light"])continue;let n=i.children;var t=!1;for(let e=0;e<n.length;e++)if(n[e].components.navmesh){t=!0;break}t||i.setAttribute("object-region-follower",{size:this.size,dynamic:!1})}!function(){if(!window.APP||!window.APP.componentRegistry)return null;console.log("showing/hiding all objects");const e=window.APP.componentRegistry["object-region-follower"]||[];for(let t=0;t<e.length;t++){const a=e[t];let i=!!s[a.region];a.el.object3D.visible!=i&&(console.log((i?"showing ":"hiding ")+a.el.className),a.showHide(i))}}()},update:function(){this.data.size!==this.size&&0==this.data.size&&(this.data.size=10,this.size=this.parseNodeName(this.data.size))},remove:function(){this.el.sceneEl.removeEventListener("environment-scene-loaded",this.sceneLoaded)},tick:function(e){if(0!=this.size){var t=this.el.sceneEl.querySelectorAll("[player-info]:not([avatar-region-follower])");t.forEach((e=>{e.setAttribute("avatar-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool]:not([object-region-follower]), a-scene > [media-loader]:not([object-region-follower])")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})}))}},parseNodeName:function(e){this.nodeName=this.el.parentEl.parentEl.className;const t=this.nodeName.match(/_([0-9]*)$/);if(!t||t.length<2)return console.warn("region-hider componentName not formatted correctly: ",this.nodeName),e;{let a=parseInt(t[1]);return a||e}}});let p={uniforms:"insertbefore:#include <common>\n",functions:"insertafter:#include <clipping_planes_pars_vertex>\n",preTransform:"insertafter:#include <begin_vertex>\n",postTransform:"insertafter:#include <project_vertex>\n",preNormal:"insertafter:#include <beginnormal_vertex>\n"},d={uniforms:"insertbefore:#include <common>\n",functions:"insertafter:#include <clipping_planes_pars_fragment>\n",preFragColor:"insertbefore:gl_FragColor = vec4( outgoingLight, diffuseColor.a );\n",postFragColor:"insertafter:gl_FragColor = vec4( outgoingLight, diffuseColor.a );\n",postMap:"insertafter:#include <map_fragment>\n",replaceMap:"replace:#include <map_fragment>\n"};const u=(e,t,a)=>{let i;for(let r in t)a[r]&&(i=/insert(before):(.*)|insert(after):(.*)|(replace):(.*)/.exec(t[r]),i&&(i[1]?e=e.replace(i[2],a[r]+"\n"+i[2]):i[3]?e=e.replace(i[4],i[4]+"\n"+a[r]):i[5]&&(e=e.replace(i[6],a[r]))));return e};function f(e){var t={};for(var a in e)for(var i in t[a]={},e[a]){var r=e[a][i];r&&(r.isColor||r.isMatrix3||r.isMatrix4||r.isVector2||r.isVector3||r.isVector4||r.isTexture)?t[a][i]=r.clone():Array.isArray(r)?t[a][i]=r.slice():t[a][i]=r}return t}let v,g={MeshStandardMaterial:"standard",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshDepthMaterial:"depth",standard:"standard",basic:"basic",lambert:"lambert",phong:"phong",depth:"depth"};const x=e=>{if(!v){let e={standard:THREE.MeshStandardMaterial,basic:THREE.MeshBasicMaterial,lambert:THREE.MeshLambertMaterial,phong:THREE.MeshPhongMaterial,depth:THREE.MeshDepthMaterial};v={};for(let t in e)v[t]={ShaderClass:e[t],ShaderLib:THREE.ShaderLib[t],Key:t,Count:0,ModifiedName:function(){return`ModifiedMesh${this.Key[0].toUpperCase()+this.Key.slice(1)}Material_${++this.Count}`},TypeCheck:`isMesh${t[0].toUpperCase()+t.slice(1)}Material`}}let t;if("function"==typeof e){for(let a in v)if(v[a].ShaderClass===e){t=v[a];break}}else if("string"==typeof e){t=v[g[e]||e]}if(!t)throw new Error("No Shader found to modify...");return t};let y=new class{constructor(e,t){this._vertexHooks={},this._fragmentHooks={},e&&this.defineVertexHooks(e),t&&this.defineFragmentHooks(t)}modify(e,t){let a=x(e);return{vertexShader:u(a.ShaderLib.vertexShader,this._vertexHooks,t.vertexShader||{}),fragmentShader:u(a.ShaderLib.fragmentShader,this._fragmentHooks,t.fragmentShader||{}),uniforms:Object.assign({},a.ShaderLib.uniforms,t.uniforms||{})}}extend(e,t){let a=x(e),i=u(a.ShaderLib.vertexShader,this._vertexHooks,t.vertexShader||{}),r=u(a.ShaderLib.fragmentShader,this._fragmentHooks,t.fragmentShader||{}),o=Object.assign({},a.ShaderLib.uniforms,t.uniforms||{}),n=t.className||a.ModifiedName(),s=new Function("BaseClass","uniforms","vertexShader","fragmentShader","cloneUniforms",`\n\n            let cls = class ${n} extends BaseClass {\n                constructor( params ){\n                    super(params)\n    \n                    this.uniforms = cloneUniforms( uniforms );\n    \n                    this.vertexShader = vertexShader;\n                    this.fragmentShader = fragmentShader;\n                    this.type = '${n}';\n    \n                    this.setValues( params );\n                }\n    \n                copy( source ){\n    \n                    super.copy(source );\n    \n                    this.uniforms = Object.assign( {}, source.uniforms );\n                    this.vertexShader = vertexShader;\n                    this.fragmentShader = fragmentShader;\n                    this.type = '${n}';\n    \n                    return this;\n    \n                }\n    \n            }\n            // var cls = function ${n}( params ){\n\n            //     //BaseClass.prototype.constructor.call( this, params );\n\n            //     this.uniforms = cloneUniforms( uniforms );\n\n            //     this.vertexShader = vertexShader;\n            //     this.fragmentShader = fragmentShader;\n            //     this.type = '${n}';\n\n            //     this.setValues( params );\n\n            // }\n\n            // cls.prototype = Object.create( BaseClass.prototype );\n            // cls.prototype.constructor = cls;\n            // cls.prototype.${a.TypeCheck} = true;\n\n            // cls.prototype.copy = function( source ){\n\n            //     BaseClass.prototype.copy.call( this, source );\n\n            //     this.uniforms = Object.assign( {}, source.uniforms );\n            //     this.vertexShader = vertexShader;\n            //     this.fragmentShader = fragmentShader;\n            //     this.type = '${n}';\n\n            //     return this;\n\n            // }\n\n            return cls;\n\n        `);return t.postModifyVertexShader&&(i=t.postModifyVertexShader(i)),t.postModifyFragmentShader&&(r=t.postModifyFragmentShader(r)),s(a.ShaderClass,o,i,r,f)}defineVertexHooks(e){for(let t in e)this._vertexHooks[t]=e[t]}defineFragmentHooks(e){for(let t in e)this._fragmentHooks[t]=e[t]}}(p,d);var b="\n        // above here, the texture lookup will be done, which we\n        // can disable by removing the map from the material\n        // but if we leave it, we can also choose the blend the texture\n        // with our shader created color, or use it in the shader or\n        // whatever\n        //\n        // vec4 texelColor = texture2D( map, vUv );\n        // texelColor = mapTexelToLinear( texelColor );\n        \n        vec2 uv = mod(vUv.xy, vec2(1.0,1.0)); //mod(vUv.xy * texRepeat.xy + texOffset.xy, vec2(1.0,1.0));\n\n        if (uv.x < 0.0) { uv.x = uv.x + 1.0;}\n        if (uv.y < 0.0) { uv.y = uv.y + 1.0;}\n        if (texFlipY > 0) { uv.y = 1.0 - uv.y;}\n        uv.x = clamp(uv.x, 0.0, 1.0);\n        uv.y = clamp(uv.y, 0.0, 1.0);\n        \n        vec4 shaderColor;\n        mainImage(shaderColor, uv.xy * iResolution.xy);\n        shaderColor = mapTexelToLinear( shaderColor );\n\n        diffuseColor *= shaderColor;\n",E={iTime:{value:0},iResolution:{value:new THREE.Vector3(512,512,1)},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)},texFlipY:{value:0}},w="\nuniform vec3 iResolution;\nuniform float iTime;\nuniform vec2 texRepeat;\nuniform vec2 texOffset;\nuniform int texFlipY; \n  ";const T=String.raw,R=Object.assign({},E,{iChannel0:{value:null}});var C;(new THREE.TextureLoader).load("https://resources.realitymedia.digital/core-components/a448e34b8136fae5.png",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,C=e}));let S={uniforms:R,vertexShader:{},fragmentShader:{uniforms:w+T`
      ...
      `,replaceMap:b},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.texFlipY={value:t.map.flipY?0:1},e.uniforms.iChannel0.value=C},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e,t.uniforms.iChannel0.value=C}};const D=String.raw;let M={uniforms:Object.assign({},E),vertexShader:{},fragmentShader:{uniforms:w,functions:D`
        ...
        void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
            ...
            `,replaceMap:b},init:function(e){let t=e;e.uniforms.texFlipY={value:t.map.flipY?0:1}},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e}};const H=String.raw;let _={uniforms:Object.assign({},E),vertexShader:{},fragmentShader:{uniforms:w,functions:H`
      //// COLORS ////
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    `},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.mb_invert={value:t.map.flipY?G.invert:!G.invert},e.uniforms.mb_offsetA={value:new THREE.Vector2(G.offsetAX+Math.random(),G.offsetAY+Math.random())},e.uniforms.mb_offsetB={value:new THREE.Vector2(G.offsetBX+Math.random(),G.offsetBY+Math.random())}},updateUniforms:function(e,t){t.uniforms.mb_time.value=.001*e}};const $=String.raw,Z=Object.assign({},E,{iChannel0:{value:null},iChannel1:{value:null}}),J=new THREE.TextureLoader;var K,Q;J.load(A,(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,K=e})),J.load("https://resources.realitymedia.digital/core-components/1ec965c5d6df577c.jpg",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,Q=e}));let ee={uniforms:Z,vertexShader:{},fragmentShader:{uniforms:w+$`
        uniform sampler2D iChannel0;
        ...
        `,replaceMap:b},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.texFlipY={value:t.map.flipY?0:1},e.uniforms.iChannel0.value=K,e.uniforms.iChannel1.value=Q,e.userData.timeOffset=1e4*(Math.random()+.5)},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e+t.userData.timeOffset,t.uniforms.iChannel0.value=K,t.uniforms.iChannel1.value=Q}};var te="https://resources.realitymedia.digital/core-components/481a92b44e56dad4.png";const ae=String.raw,ie={warpTime:{value:0},warpTex:{value:null},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)},texFlipY:{value:0}};var re;(new THREE.TextureLoader).load(te,(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,re=e}));let oe={uniforms:ie,vertexShader:{},fragmentShader:{uniforms:ae`
        ...
        uniform int texFlipY; 
          ...
          diffuseColor *= col;
        `},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.texFlipY={value:t.map.flipY?0:1},e.userData.timeOffset=10*(Math.random()+.5),e.uniforms.warpTex.value=re,e.uniforms.warpTime={value:0}},updateUniforms:function(e,t){t.uniforms.warpTime.value=.001*e+t.userData.timeOffset,t.uniforms.warpTex.value=re}};const ne=String.raw,se={warpTime:{value:0},warpTex:{value:null},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)},texFlipY:{value:0},portalCubeMap:{value:new THREE.CubeTexture},portalTime:{value:0},portalRadius:{value:.5},portalRingColor:{value:new THREE.Color("red")},invertWarpColor:{value:0},texInvSize:{value:new THREE.Vector2(1,1)}};let le=new THREE.CubeTexture;var ce;(new THREE.TextureLoader).load(te,(e=>{e.minFilter=THREE.NearestMipmapNearestFilter,e.magFilter=THREE.NearestMipmapNearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,ce=e,le.images=[e.image,e.image,e.image,e.image,e.image,e.image],le.needsUpdate=!0}));let he={uniforms:se,vertexShader:{uniforms:ne`
        varying vec3 vRay;
