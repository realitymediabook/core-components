  ...
  `},w=new THREE.Vector3,E=new THREE.Vector3(0,0,1);AFRAME.registerComponent("parallax",{schema:{strength:{type:"number",default:.5},cutoffTransition:{type:"number",default:Math.PI/8},cutoffAngle:{type:"number",default:Math.PI/4}},init:function(){const e=this.el.object3DMap.mesh,{map:t,emissiveMap:i}=e.material;t.wrapS=t.wrapT=THREE.ClampToEdgeWrapping,i.wrapS=i.wrapT=THREE.ClampToEdgeWrapping;const{vertexShader:o,fragmentShader:a}=b;this.material=new THREE.ShaderMaterial({vertexShader:o,fragmentShader:a,defines:{USE_OCLUSION_PARALLAX:!0},uniforms:{map:{value:t},bumpMap:{value:i},parallaxScale:{value:-1*this.data.strength},parallaxMinLayers:{value:20},parallaxMaxLayers:{value:30},fade:{value:0}}}),e.material=this.material},tick(){if(this.el.sceneEl.camera){this.el.sceneEl.camera.getWorldPosition(w),this.el.object3D.worldToLocal(w);const l=w.angleTo(E),c=(e=l,t=this.data.cutoffAngle-this.data.cutoffTransition,i=this.data.cutoffAngle+this.data.cutoffTransition,r=function(e,t,i,o,a){return o+(e-t)*(a-o)/(i-t)}(e,t,i,o=0,a=1),n=o,s=a,Math.max(n,Math.min(s,r)));this.material.uniforms.fade.value=c}var e,t,i,o,a,r,n,s}});let C={uniforms:"insertbefore:#include <common>\n",functions:"insertafter:#include <clipping_planes_pars_vertex>\n",preTransform:"insertafter:#include <begin_vertex>\n",postTransform:"insertafter:#include <project_vertex>\n",preNormal:"insertafter:#include <beginnormal_vertex>\n"},T={uniforms:"insertbefore:#include <common>\n",functions:"insertafter:#include <clipping_planes_pars_fragment>\n",preFragColor:"insertbefore:gl_FragColor = vec4( outgoingLight, diffuseColor.a );\n",postFragColor:"insertafter:gl_FragColor = vec4( outgoingLight, diffuseColor.a );\n",postMap:"insertafter:#include <map_fragment>\n",replaceMap:"replace:#include <map_fragment>\n"};const R=(e,t,i)=>{let o;for(let a in t)i[a]&&(o=/insert(before):(.*)|insert(after):(.*)|(replace):(.*)/.exec(t[a]),o&&(o[1]?e=e.replace(o[2],i[a]+"\n"+o[2]):o[3]?e=e.replace(o[4],o[4]+"\n"+i[a]):o[5]&&(e=e.replace(o[6],i[a]))));return e};function _(e){var t={};for(var i in e)for(var o in t[i]={},e[i]){var a=e[i][o];a&&(a.isColor||a.isMatrix3||a.isMatrix4||a.isVector2||a.isVector3||a.isVector4||a.isTexture)?t[i][o]=a.clone():Array.isArray(a)?t[i][o]=a.slice():t[i][o]=a}return t}let S,A={MeshStandardMaterial:"standard",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshDepthMaterial:"depth",standard:"standard",basic:"basic",lambert:"lambert",phong:"phong",depth:"depth"};const M=e=>{if(!S){let e={standard:THREE.MeshStandardMaterial,basic:THREE.MeshBasicMaterial,lambert:THREE.MeshLambertMaterial,phong:THREE.MeshPhongMaterial,depth:THREE.MeshDepthMaterial};S={};for(let t in e)S[t]={ShaderClass:e[t],ShaderLib:THREE.ShaderLib[t],Key:t,Count:0,ModifiedName:function(){return`ModifiedMesh${this.Key[0].toUpperCase()+this.Key.slice(1)}Material_${++this.Count}`},TypeCheck:`isMesh${t[0].toUpperCase()+t.slice(1)}Material`}}let t;if("function"==typeof e){for(let i in S)if(S[i].ShaderClass===e){t=S[i];break}}else if("string"==typeof e){t=S[A[e]||e]}if(!t)throw new Error("No Shader found to modify...");return t};let L=new class{_vertexHooks;_fragmentHooks;constructor(e,t){this._vertexHooks={},this._fragmentHooks={},e&&this.defineVertexHooks(e),t&&this.defineFragmentHooks(t)}modify(e,t){let i=M(e);return{vertexShader:R(i.ShaderLib.vertexShader,this._vertexHooks,t.vertexShader||{}),fragmentShader:R(i.ShaderLib.fragmentShader,this._fragmentHooks,t.fragmentShader||{}),uniforms:Object.assign({},i.ShaderLib.uniforms,t.uniforms||{})}}extend(e,t){let i=M(e),o=R(i.ShaderLib.vertexShader,this._vertexHooks,t.vertexShader||{}),a=R(i.ShaderLib.fragmentShader,this._fragmentHooks,t.fragmentShader||{}),r=Object.assign({},i.ShaderLib.uniforms,t.uniforms||{}),n=t.className||i.ModifiedName(),s=new Function("BaseClass","uniforms","vertexShader","fragmentShader","cloneUniforms",`\n\n            var cls = function ${n}( params ){\n\n                BaseClass.call( this, params );\n\n                this.uniforms = cloneUniforms( uniforms );\n\n                this.vertexShader = vertexShader;\n                this.fragmentShader = fragmentShader;\n                this.type = '${n}';\n\n                this.setValues( params );\n\n            }\n\n            cls.prototype = Object.create( BaseClass.prototype );\n            cls.prototype.constructor = cls;\n            cls.prototype.${i.TypeCheck} = true;\n\n            cls.prototype.copy = function( source ){\n\n                BaseClass.prototype.copy.call( this, source );\n\n                this.uniforms = Object.assign( {}, source.uniforms );\n                this.vertexShader = vertexShader;\n                this.fragmentShader = fragmentShader;\n                this.type = '${n}';\n\n                return this;\n\n            }\n\n            return cls;\n\n        `);return t.postModifyVertexShader&&(o=t.postModifyVertexShader(o)),t.postModifyFragmentShader&&(a=t.postModifyFragmentShader(a)),s(i.ShaderClass,r,o,a,_)}defineVertexHooks(e){for(let t in e)this._vertexHooks[t]=e[t]}defineFragmentHooks(e){for(let t in e)this._fragmentHooks[t]=e[t]}}(C,T);var N="\n        // above here, the texture lookup will be done, which we\n        // can disable by removing the map from the material\n        // but if we leave it, we can also choose the blend the texture\n        // with our shader created color, or use it in the shader or\n        // whatever\n        //\n        // vec4 texelColor = texture2D( map, vUv );\n        // texelColor = mapTexelToLinear( texelColor );\n        \n        vec2 uv = mod(vUv.xy, vec2(1.0,1.0)); //mod(vUv.xy * texRepeat.xy + texOffset.xy, vec2(1.0,1.0));\n\n        if (uv.x < 0.0) { uv.x = uv.x + 1.0;}\n        if (uv.y < 0.0) { uv.y = uv.y + 1.0;}\n        if (texFlipY > 0) { uv.y = 1.0 - uv.y;}\n        uv.x = clamp(uv.x, 0.0, 1.0);\n        uv.y = clamp(uv.y, 0.0, 1.0);\n        \n        vec4 shaderColor;\n        mainImage(shaderColor, uv.xy * iResolution.xy);\n        shaderColor = mapTexelToLinear( shaderColor );\n\n        diffuseColor *= shaderColor;\n",D={iTime:{value:0},iResolution:{value:new THREE.Vector3(512,512,1)},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)},texFlipY:{value:0}},P="\nuniform vec3 iResolution;\nuniform float iTime;\nuniform vec2 texRepeat;\nuniform vec2 texOffset;\nuniform int texFlipY; \n  ";const H=String.raw,z=Object.assign({},D,{iChannel0:{value:null}});var k;(new THREE.TextureLoader).load("https://resources.realitymedia.digital/core-components/a448e34b8136fae5.png",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,k=e}));let F={uniforms:z,vertexShader:{},fragmentShader:{uniforms:P+H`
      ...
      `,replaceMap:N},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.texFlipY={value:t.map.flipY?0:1},e.uniforms.iChannel0.value=k},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e,t.uniforms.iChannel0.value=k}};const O=String.raw;let j={uniforms:Object.assign({},D),vertexShader:{},fragmentShader:{uniforms:P,functions:O`
        ...
        void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
            ...
            `,replaceMap:N},init:function(e){let t=e;e.uniforms.texFlipY={value:t.map.flipY?0:1}},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e}};const I=String.raw;let q={uniforms:Object.assign({},D),vertexShader:{},fragmentShader:{uniforms:P,functions:I`
      //// COLORS ////
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    `,replaceMap:N},init:function(e){let t=e;e.uniforms.texRepeat={value:t.map.repeat},e.uniforms.texOffset={value:t.map.offset},e.uniforms.texFlipY={value:t.map.flipY?0:1},e.userData.timeOffset=10*(Math.random()+.5)},updateUniforms:function(e,t){t.uniforms.iTime.value=.0012*e+t.userData.timeOffset}};const oe=String.raw,ae={animate:!1,noiseMode:"scale",invert:!1,sharpen:!0,scaleByPrev:!1,gain:.54,lacunarity:2,octaves:5,scale1:3,scale2:3,timeScaleX:.4,timeScaleY:.3,color1:[0,0,0],color2:[130,129,129],color3:[110,110,110],color4:[82,51,13],offsetAX:0,offsetAY:0,offsetBX:3.7,offsetBY:.9,offsetCX:2.1,offsetCY:3.2,offsetDX:4.3,offsetDY:2.8,offsetX:0,offsetY:0};let re={uniforms:{mb_animate:{value:ae.animate},mb_color1:{value:ae.color1.map((e=>e/255))},mb_color2:{value:ae.color2.map((e=>e/255))},mb_color3:{value:ae.color3.map((e=>e/255))},mb_color4:{value:ae.color4.map((e=>e/255))},mb_gain:{value:ae.gain},mb_invert:{value:ae.invert},mb_lacunarity:{value:ae.lacunarity},mb_noiseMode:{value:0},mb_octaves:{value:ae.octaves},mb_offset:{value:[ae.offsetX,ae.offsetY]},mb_offsetA:{value:[ae.offsetAX,ae.offsetAY]},mb_offsetB:{value:[ae.offsetBX,ae.offsetBY]},mb_offsetC:{value:[ae.offsetCX,ae.offsetCY]},mb_offsetD:{value:[ae.offsetDX,ae.offsetDY]},mb_scale1:{value:ae.scale1},mb_scale2:{value:ae.scale2},mb_scaleByPrev:{value:ae.scaleByPrev},mb_sharpen:{value:ae.sharpen},mb_time:{value:0},mb_timeScale:{value:[ae.timeScaleX,ae.timeScaleY]},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)}},vertexShader:{},fragmentShader:{uniforms:oe`
