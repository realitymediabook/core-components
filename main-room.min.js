import{THREE as e}from"ethereal";import*as t from"https://resources.realitymedia.digital/vue-apps/dist/hubs.js";AFRAME.registerSystem("fader-plus",{schema:{direction:{type:"string",default:"none"},duration:{type:"number",default:200},color:{type:"color",default:"white"}},init(){const e=new THREE.Mesh(new THREE.BoxGeometry,new THREE.MeshBasicMaterial({color:this.data.color,side:THREE.BackSide,opacity:0,transparent:!0,fog:!1}));e.scale.x=e.scale.y=1,e.scale.z=.15,e.matrixNeedsUpdate=!0,e.renderOrder=1,this.el.camera.add(e),this.mesh=e},fadeOut(){return this.beginTransition("out")},fadeIn(){return this.beginTransition("in")},async beginTransition(e){if(this._resolveFinish)throw new Error("Cannot fade while a fade is happening.");return this.el.setAttribute("fader-plus",{direction:e}),new Promise((t=>{this.mesh.material.opacity===("in"==e?0:1)?t():this._resolveFinish=t}))},tick(e,t){const i=this.mesh.material;this.mesh.visible="out"===this.data.direction||0!==i.opacity,this.mesh.visible&&("in"===this.data.direction?i.opacity=Math.max(0,i.opacity-1/this.data.duration*Math.min(t,50)):"out"===this.data.direction&&(i.opacity=Math.min(1,i.opacity+1/this.data.duration*Math.min(t,50))),0!==i.opacity&&1!==i.opacity||("none"!==this.data.direction&&this._resolveFinish&&(this._resolveFinish(),this._resolveFinish=null),this.el.setAttribute("fader-plus",{direction:"none"})))}});const i=new THREE.Vector3,o=new THREE.Vector3;AFRAME.registerComponent("proximity-events",{schema:{radius:{type:"number",default:1}},init(){this.inZone=!1,this.camera=this.el.sceneEl.camera},tick(){this.camera.getWorldPosition(i),this.el.object3D.getWorldPosition(o);const e=this.inZone;this.inZone=i.distanceTo(o)<this.data.radius,this.inZone&&!e&&this.el.emit("proximityenter"),!this.inZone&&e&&this.el.emit("proximityleave")}});function a(e,t){window.APP.componentRegistry=window.APP.componentRegistry||{},window.APP.componentRegistry[t]=window.APP.componentRegistry[t]||[],window.APP.componentRegistry[t].push(e)}function r(e,t){window.APP.componentRegistry&&window.APP.componentRegistry[t]&&window.APP.componentRegistry[t].splice(window.APP.componentRegistry[t].indexOf(e),1)}let n=function(e,t){let i=t.position;return 1e6*(Math.floor(i.x/e)+5e5)+(Math.floor(i.z/e)+5e5)},s=[];function l(e){let t=e;for(;t&&t.components&&!t.components["object-region-follower"];)t=t.parentNode;if(t&&t.components&&t.components["object-region-follower"])return t.components["object-region-follower"]}function c(e){s[e]?s[e]++:s[e]=1,console.log("Avatars in region "+e+": "+s[e]),1==s[e]?h(e,!0):console.log("already another avatar in this region, no change")}function m(e){s[e]&&s[e]--,console.log("Avatars left region "+e+": "+s[e]),0==s[e]?h(e,!1):console.log("still another avatar in this region, no change")}function h(e,t){if(!window.APP||!window.APP.componentRegistry)return null;console.log((t?"showing":"hiding")+" all objects in region "+e);const i=window.APP.componentRegistry["object-region-follower"]||[];for(let o=0;o<i.length;o++){const a=i[o];a.region==e&&(console.log((t?"showing ":" hiding")+a.el.className),a.showHide(t))}return null}AFRAME.registerComponent("avatar-region-follower",{schema:{size:{default:10}},init:function(){this.region=n(this.data.size,this.el.object3D),console.log("Avatar: region ",this.region),c(this.region),a(this,"avatar-region-follower")},remove:function(){r(this,"avatar-region-follower"),m(this.region)},tick:function(){let e=n(this.data.size,this.el.object3D);e!=this.region&&(m(this.region),c(e),this.region=e)}}),AFRAME.registerComponent("object-region-follower",{schema:{size:{default:10},dynamic:{default:!0}},init:function(){this.region=n(this.data.size,this.el.object3D),this.showHide=this.showHide.bind(this),this.el.components["media-video"]&&(this.wasPaused=this.el.components["media-video"].data.videoPaused),a(this,"object-region-follower")},remove:function(){r(this,"object-region-follower")},tick:function(){if(!this.data.dynamic)return;this.region=n(this.data.size,this.el.object3D);let e=!!s[this.region];this.el.object3D.visible!=e&&this.showHide(e)},showHide:function(e){this.el.object3D.visible=e,this.el.components["media-video"]&&(e?this.wasPaused!=this.el.components["media-video"].data.videoPaused&&this.el.components["media-video"].togglePlaying():(this.wasPaused=this.el.components["media-video"].data.videoPaused,this.wasPaused||this.el.components["media-video"].togglePlaying()))}}),AFRAME.registerComponent("region-hider",{schema:{size:{default:10}},init:function(){if(!function(e,t){for(;e&&(!e.components||!e.components[t]);)e=e.parentNode;return e}(this.el,"nav-mesh-helper"))return console.warn("region-hider component must be in the environment scene glb."),void(this.size=0);this.nodeName=this.el.parentEl.parentEl.className,0==this.data.size&&(this.data.size=10),this.size=this.parseNodeName(this.data.size);let e=document.getElementsByClassName("RoomObjects");this.roomObjects=e.length>0?e[0]:null;this.el.sceneEl.querySelectorAll("[player-info]").forEach((e=>{e.setAttribute("avatar-region-follower",{size:this.size})}));var t=this.el.sceneEl.querySelectorAll(".RoomObjects > [media-loader]");t.forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool], a-scene > [media-loader]")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool]")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})})),this.sceneLoaded=this.sceneLoaded.bind(this),this.el.sceneEl.addEventListener("environment-scene-loaded",this.sceneLoaded)},sceneLoaded:function(){var e=this.el.parentEl.parentEl.parentEl.childNodes;for(let i=0;i<e.length;i++){let o=e[i];if(o==this.el.parentEl.parentEl)continue;let a=o.className;if("CombinedMesh"===a||"scene-preview-camera"===a)continue;let r=o.components;if(r.waypoint||r.skybox||r["directional-light"]||r["ambient-light"]||r["hemisphere-light"])continue;let n=o.children;var t=!1;for(let e=0;e<n.length;e++)if(n[e].components.navmesh){t=!0;break}t||o.setAttribute("object-region-follower",{size:this.size,dynamic:!1})}!function(){if(!window.APP||!window.APP.componentRegistry)return null;console.log("showing/hiding all objects");const e=window.APP.componentRegistry["object-region-follower"]||[];for(let t=0;t<e.length;t++){const i=e[t];let o=!!s[i.region];i.el.object3D.visible!=o&&(console.log((o?"showing ":"hiding ")+i.el.className),i.showHide(o))}}()},update:function(){0==this.data.size&&(this.data.size=10),this.data.size!==this.size&&(this.size=this.parseNodeName(this.data.size))},remove:function(){this.el.sceneEl.removeEventListener("environment-scene-loaded",this.sceneLoaded)},tick:function(e){if(0!=this.size){var t=this.el.sceneEl.querySelectorAll("[player-info]:not([avatar-region-follower])");t.forEach((e=>{e.setAttribute("avatar-region-follower",{size:this.size})})),(t=this.el.sceneEl.querySelectorAll("[camera-tool]:not([object-region-follower]), a-scene > [media-loader]:not([object-region-follower])")).forEach((e=>{e.setAttribute("object-region-follower",{size:this.size})}))}},parseNodeName:function(e){const t=this.nodeName.match(/_([0-9]*)$/);if(!t||t.length<2)return console.warn("region-hider componentName not formatted correctly: ",this.nodeName),e;{let i=parseInt(t[1]);return i||e}}});const d=new THREE.Vector3,f=new THREE.Vector3,p=new THREE.Vector3,u=new THREE.Quaternion,v=new THREE.Matrix4;AFRAME.registerSystem("portal",{dependencies:["fader-plus"],init:function(){this.teleporting=!1,this.characterController=this.el.systems["hubs-systems"].characterController,this.fader=this.el.systems["fader-plus"],this.roomData=null,this.waitForFetch=this.waitForFetch.bind(this),window.APP.store.state.credentials&&window.APP.store.state.credentials.token&&!window.APP.userData&&this.fetchRoomData()},fetchRoomData:async function(){var e={token:window.APP.store.state.credentials.token,room_id:window.APP.hubChannel.hubId};const t={};t.headers=new Headers,t.headers.set("Authorization",`Bearer ${e}`),t.headers.set("Content-Type","application/json"),await fetch("https://realitymedia.digital/userData",t).then((e=>e.json())).then((e=>{console.log("Success:",e),this.roomData=e})),this.roomData.textures=[]},getRoomURL:async function(e){return this.waitForFetch(),this.roomData.rooms.length>e?"https://xr.realitymedia.digital/"+this.roomData.rooms[e]:null},getCubeMap:async function(e){return this.waitForFetch(),this.roomData.cubemaps.length>e?this.roomData.cubemaps[e]:null},waitForFetch:function(){this.roomData||setTimeout(this.waitForFetch,100)},teleportTo:async function(e){this.teleporting=!0,await this.fader.fadeOut(),e.getWorldQuaternion(u),e.getWorldDirection(p),e.getWorldPosition(d),d.add(p.multiplyScalar(1.5)),v.makeRotationFromQuaternion(u),v.setPosition(d),this.characterController.travelByWaypoint(v,!0,!1),await this.fader.fadeIn(),this.teleporting=!1}}),AFRAME.registerComponent("portal",{schema:{color:{type:"color",default:null}},init:async function(){this.system=APP.scene.systems.portal,this.parseNodeName(),this.material=new THREE.ShaderMaterial({transparent:!0,side:THREE.DoubleSide,uniforms:{cubeMap:{value:new THREE.Texture},time:{value:0},radius:{value:0},ringColor:{value:this.color}},vertexShader:"\nvarying vec2 vUv;\nvarying vec3 vRay;\nvarying vec3 vNormal;\n\nvoid main() {\n  vUv = uv;\n  // vNormal = normalMatrix * normal;\n  vec3 cameraLocal = (inverse(modelMatrix) * vec4(cameraPosition, 1.0)).xyz;\n  vRay = position - cameraLocal;\n  vNormal = normalize(-1. * vRay);\n  float dist = length(cameraLocal);\n  vRay.z *= 1.3 / (1. + pow(dist, 0.5)); // Change FOV by squashing local Z direction\n  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n}\n",fragmentShader:"\n        \n//\n// Description : Array and textureless GLSL 2D/3D/4D simplex\n//               noise functions.\n//      Author : Ian McEwan, Ashima Arts.\n//  Maintainer : ijm\n//     Lastmod : 20110822 (ijm)\n//     License : Copyright (C) 2011 Ashima Arts. All rights reserved.\n//               Distributed under the MIT License. See LICENSE file.\n//               https://github.com/ashima/webgl-noise\n//\n\nvec3 mod289(vec3 x) {\n  return x - floor(x * (1.0 / 289.0)) * 289.0;\n}\n\nvec4 mod289(vec4 x) {\n  return x - floor(x * (1.0 / 289.0)) * 289.0;\n}\n\nvec4 permute(vec4 x) {\n     return mod289(((x*34.0)+1.0)*x);\n}\n\nvec4 taylorInvSqrt(vec4 r)\n{\n  return 1.79284291400159 - 0.85373472095314 * r;\n}\n\nfloat snoise(vec3 v)\n  {\n  const vec2  C = vec2(1.0/6.0, 1.0/3.0) ;\n  const vec4  D = vec4(0.0, 0.5, 1.0, 2.0);\n\n// First corner\n  vec3 i  = floor(v + dot(v, C.yyy) );\n  vec3 x0 =   v - i + dot(i, C.xxx) ;\n\n// Other corners\n  vec3 g = step(x0.yzx, x0.xyz);\n  vec3 l = 1.0 - g;\n  vec3 i1 = min( g.xyz, l.zxy );\n  vec3 i2 = max( g.xyz, l.zxy );\n\n  //   x0 = x0 - 0.0 + 0.0 * C.xxx;\n  //   x1 = x0 - i1  + 1.0 * C.xxx;\n  //   x2 = x0 - i2  + 2.0 * C.xxx;\n  //   x3 = x0 - 1.0 + 3.0 * C.xxx;\n  vec3 x1 = x0 - i1 + C.xxx;\n  vec3 x2 = x0 - i2 + C.yyy; // 2.0*C.x = 1/3 = C.y\n  vec3 x3 = x0 - D.yyy;      // -1.0+3.0*C.x = -0.5 = -D.y\n\n// Permutations\n  i = mod289(i);\n  vec4 p = permute( permute( permute(\n             i.z + vec4(0.0, i1.z, i2.z, 1.0 ))\n           + i.y + vec4(0.0, i1.y, i2.y, 1.0 ))\n           + i.x + vec4(0.0, i1.x, i2.x, 1.0 ));\n\n// Gradients: 7x7 points over a square, mapped onto an octahedron.\n// The ring size 17*17 = 289 is close to a multiple of 49 (49*6 = 294)\n  float n_ = 0.142857142857; // 1.0/7.0\n  vec3  ns = n_ * D.wyz - D.xzx;\n\n  vec4 j = p - 49.0 * floor(p * ns.z * ns.z);  //  mod(p,7*7)\n\n  vec4 x_ = floor(j * ns.z);\n  vec4 y_ = floor(j - 7.0 * x_ );    // mod(j,N)\n\n  vec4 x = x_ *ns.x + ns.yyyy;\n  vec4 y = y_ *ns.x + ns.yyyy;\n  vec4 h = 1.0 - abs(x) - abs(y);\n\n  vec4 b0 = vec4( x.xy, y.xy );\n  vec4 b1 = vec4( x.zw, y.zw );\n\n  //vec4 s0 = vec4(lessThan(b0,0.0))*2.0 - 1.0;\n  //vec4 s1 = vec4(lessThan(b1,0.0))*2.0 - 1.0;\n  vec4 s0 = floor(b0)*2.0 + 1.0;\n  vec4 s1 = floor(b1)*2.0 + 1.0;\n  vec4 sh = -step(h, vec4(0.0));\n\n  vec4 a0 = b0.xzyw + s0.xzyw*sh.xxyy ;\n  vec4 a1 = b1.xzyw + s1.xzyw*sh.zzww ;\n\n  vec3 p0 = vec3(a0.xy,h.x);\n  vec3 p1 = vec3(a0.zw,h.y);\n  vec3 p2 = vec3(a1.xy,h.z);\n  vec3 p3 = vec3(a1.zw,h.w);\n\n//Normalise gradients\n  vec4 norm = taylorInvSqrt(vec4(dot(p0,p0), dot(p1,p1), dot(p2, p2), dot(p3,p3)));\n  p0 *= norm.x;\n  p1 *= norm.y;\n  p2 *= norm.z;\n  p3 *= norm.w;\n\n// Mix final noise value\n  vec4 m = max(0.6 - vec4(dot(x0,x0), dot(x1,x1), dot(x2,x2), dot(x3,x3)), 0.0);\n  m = m * m;\n  return 42.0 * dot( m*m, vec4( dot(p0,x0), dot(p1,x1),\n                                dot(p2,x2), dot(p3,x3) ) );\n  }  \n\n        \nuniform samplerCube cubeMap;\nuniform float time;\nuniform float radius;\nuniform vec3 ringColor;\n\nvarying vec2 vUv;\nvarying vec3 vRay;\nvarying vec3 vNormal;\n\n#define RING_WIDTH 0.1\n#define RING_HARD_OUTER 0.01\n#define RING_HARD_INNER 0.08\n#define forward vec3(0.0, 0.0, 1.0)\n\nvoid main() {\n  vec2 coord = vUv * 2.0 - 1.0;\n  float noise = snoise(vec3(coord * 1., time)) * 0.5 + 0.5;\n\n  // Polar distance\n  float dist = length(coord);\n  dist += noise * 0.2;\n\n  float maskOuter = 1.0 - smoothstep(radius - RING_HARD_OUTER, radius, dist);\n  float maskInner = 1.0 - smoothstep(radius - RING_WIDTH, radius - RING_WIDTH + RING_HARD_INNER, dist);\n  float distortion = smoothstep(radius - 0.2, radius + 0.2, dist);\n  vec3 normal = normalize(vNormal);\n  float directView = smoothstep(0., 0.8, dot(normal, forward));\n  vec3 tangentOutward = vec3(coord, 0.0);\n  vec3 ray = mix(vRay, tangentOutward, distortion);\n  vec4 texel = textureCube(cubeMap, ray);\n  vec3 centerLayer = texel.rgb * maskInner;\n  vec3 ringLayer = ringColor * (1. - maskInner);\n  vec3 composite = centerLayer + ringLayer;\n\n  gl_FragColor = vec4(composite, (maskOuter - maskInner) + maskInner * directView);\n}\n\n      "});this.el.getOrCreateObject3D("mesh").material=this.material,this.other=await this.getOther(),1==this.portalType?this.system.getCubeMap(this.portalTarget).then((e=>{new Promise(((t,i)=>(new THREE.CubeTextureLoader).load(e,t,void 0,i))).then((e=>{e.format=THREE.RGBFormat,this.material.uniforms.cubeMap.value=e})).catch((e=>console.error(e)))})):2==this.portalType&&(this.cubeCamera=new THREE.CubeCamera(1,1e5,1024),this.cubeCamera.rotateY(Math.PI),this.el.object3D.add(this.cubeCamera),this.other.components.portal.material.uniforms.cubeMap.value=this.cubeCamera.renderTarget.texture,this.el.sceneEl.addEventListener("model-loaded",(()=>{!function(e){let t=l(e);t&&(console.log("showing objects near "+t.el.className),c(t.region))}(this.el),this.cubeCamera.update(this.el.sceneEl.renderer,this.el.sceneEl.object3D),function(e){let t=l(e);t&&(console.log("hiding objects near "+t.el.className),m(t.region))}(this.el)}))),this.el.setAttribute("animation__portal",{property:"components.portal.material.uniforms.radius.value",dur:700,easing:"easeInOutCubic"}),this.el.addEventListener("animationbegin",(()=>this.el.object3D.visible=!0)),this.el.addEventListener("animationcomplete__portal",(()=>this.el.object3D.visible=!this.isClosed())),this.el.setAttribute("is-remote-hover-target",""),this.el.setAttribute("tags",{singleActionButton:!0}),this.el.setAttribute("class","interactable"),this.followPortal=this.followPortal.bind(this),this.el.object3D.addEventListener("interact",this.followPortal),this.el.setAttribute("proximity-events",{radius:5}),this.el.addEventListener("proximityenter",(()=>this.open())),this.el.addEventListener("proximityleave",(()=>this.close()))},followPortal:function(){1==this.portalType?(console.log("set window.location.href to "+this.other),window.location.href=this.other):2==this.portalType&&this.system.teleportTo(this.other.object3D)},tick:function(e){if(this.material.uniforms.time.value=e/1e3,this.other&&!this.system.teleporting){this.el.object3D.getWorldPosition(d),this.el.sceneEl.camera.getWorldPosition(f);const e=f.distanceTo(d);1==this.portalType&&e<.5||2==this.portalType&&e<1&&this.system.teleportTo(this.other.object3D)}},getOther:function(){return new Promise((e=>{0==this.portalType&&e(null),1==this.portalType&&this.system.getRoomURL(this.portalTarget).then((t=>{e(t)}));const t=Array.from(document.querySelectorAll("[portal]")).find((e=>e.components.portal.portalType==this.portalType&&e.components.portal.portalTarget===this.portalTarget&&e!==this.el));void 0!==t?(e(t),t.emit("pair",{other:this.el})):this.el.addEventListener("pair",(t=>e(t.detail.other)),{once:!0})}))},parseNodeName:function(){const e=this.el.parentEl.parentEl.className,t=e.match(/([A-Za-z]*)_([A-Za-z0-9]*)_([A-Za-z0-9]*)$/);if(!t||t.length<4)return console.warn("portal node name not formed correctly: ",e),this.portalType=0,this.portalTarget=null,void(this.color="red");"room"===t[1]?(this.portalType=1,this.portalTarget=parseInt(t[2])):"portal"===t[1]?(this.portalType=2,this.portalTarget=t[2]):(this.portalType=0,this.portalTarget=null),this.color=new THREE.Color(t[3])},setRadius(e){this.el.setAttribute("animation__portal",{from:this.material.uniforms.radius.value,to:e})},open(){this.setRadius(1)},close(){this.setRadius(0)},isClosed(){return 0===this.material.uniforms.radius.value}});const g=new THREE.Vector3,x=new THREE.Vector3;AFRAME.registerComponent("immersive-360",{schema:{url:{type:"string",default:null}},init:async function(){const e=this.data.url??this.parseSpokeName(),t=e.match(/^.*\.(.*)$/)[1];this.el.setAttribute("media-image",{projection:"360-equirectangular",alphaMode:"opaque",src:e,version:1,batch:!1,contentType:`image/${t}`,alphaCutoff:0}),this.mesh=await this.getMesh(),this.mesh.geometry.scale(100,100,100),this.mesh.material.setValues({transparent:!0,depthTest:!1}),this.near=1,this.far=1.3,this.mesh.renderOrder=APP.RENDER_ORDER.CURSOR-1},tick:function(){if(this.mesh){this.mesh.getWorldPosition(x),this.el.sceneEl.camera.getWorldPosition(g);const e=1-(x.distanceTo(g)-this.near)/(this.far-this.near);this.mesh.material.opacity=e}},parseSpokeName:function(){const e=this.el.parentEl.parentEl.className,[,t,i]=e.match(/(?:.*__)?(.*)_(.*)/);return`https://gt-ael-aq-assets.aelatgt-internal.net/files/${t}.${i}`},getMesh:async function(){return new Promise((e=>{const t=this.el.object3DMap.mesh;t&&e(t),this.el.addEventListener("image-loaded",(()=>{e(this.el.object3DMap.mesh)}),{once:!0})}))}});const y=String.raw,b={modes:{none:"NO_PARALLAX",basic:"USE_BASIC_PARALLAX",steep:"USE_STEEP_PARALLAX",occlusion:"USE_OCLUSION_PARALLAX",relief:"USE_RELIEF_PARALLAX"},uniforms:{bumpMap:{value:null},map:{value:null},parallaxScale:{value:null},parallaxMinLayers:{value:null},parallaxMaxLayers:{value:null}},vertexShader:y`
  ...
  `},w=new THREE.Vector3,E=new THREE.Vector3(0,0,1);AFRAME.registerComponent("parallax",{schema:{strength:{type:"number",default:.5},cutoffTransition:{type:"number",default:Math.PI/8},cutoffAngle:{type:"number",default:Math.PI/4}},init:function(){const e=this.el.object3DMap.mesh,{map:t,emissiveMap:i}=e.material;t.wrapS=t.wrapT=THREE.ClampToEdgeWrapping,i.wrapS=i.wrapT=THREE.ClampToEdgeWrapping;const{vertexShader:o,fragmentShader:a}=b;this.material=new THREE.ShaderMaterial({vertexShader:o,fragmentShader:a,defines:{USE_OCLUSION_PARALLAX:!0},uniforms:{map:{value:t},bumpMap:{value:i},parallaxScale:{value:-1*this.data.strength},parallaxMinLayers:{value:20},parallaxMaxLayers:{value:30},fade:{value:0}}}),e.material=this.material},tick(){if(this.el.sceneEl.camera){this.el.sceneEl.camera.getWorldPosition(w),this.el.object3D.worldToLocal(w);const l=w.angleTo(E),c=(e=l,t=this.data.cutoffAngle-this.data.cutoffTransition,i=this.data.cutoffAngle+this.data.cutoffTransition,r=function(e,t,i,o,a){return o+(e-t)*(a-o)/(i-t)}(e,t,i,o=0,a=1),n=o,s=a,Math.max(n,Math.min(s,r)));this.material.uniforms.fade.value=c}var e,t,i,o,a,r,n,s}});var C="\n        // above here, the texture lookup will be done, which we\n        // can disable by removing the map from the material\n        // but if we leave it, we can also choose the blend the texture\n        // with our shader created color, or use it in the shader or\n        // whatever\n        //\n        // vec4 texelColor = texture2D( map, vUv );\n        // texelColor = mapTexelToLinear( texelColor );\n        \n        vec2 uv = mod(vUv.xy, vec2(1.0,1.0)); //mod(vUv.xy * texRepeat.xy + texOffset.xy, vec2(1.0,1.0));\n\n        if (uv.x < 0.0) { uv.x = uv.x + 1.0;}\n        if (uv.y < 0.0) { uv.y = uv.y + 1.0;}\n        if (texFlipY > 0) { uv.y = 1.0 - uv.y;}\n        uv.x = clamp(uv.x, 0.0, 1.0);\n        uv.y = clamp(uv.y, 0.0, 1.0);\n        \n        vec4 shaderColor;\n        mainImage(shaderColor, uv.xy * iResolution.xy);\n        shaderColor = mapTexelToLinear( shaderColor );\n\n        diffuseColor *= shaderColor;\n",_={iTime:{value:0},iResolution:{value:new THREE.Vector3(1,1,1)},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)},texFlipY:{value:0}},S="\nuniform vec3 iResolution;\nuniform float iTime;\nuniform vec2 texRepeat;\nuniform vec2 texOffset;\nuniform int texFlipY; \n  ";const T=String.raw,R=Object.assign({},_,{iChannel0:{value:null}}),A=new THREE.TextureLoader;var M=null;A.load("https://resources.realitymedia.digital/data/images/bayer.png",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,M=e}));let D={uniforms:R,vertexShader:{},fragmentShader:{uniforms:S+T`
      ...
      `,replaceMap:C},init:function(e){e.uniforms.texRepeat={value:e.map.repeat},e.uniforms.texOffset={value:e.map.offset},e.uniforms.texFlipY={value:e.map.flipY?1:0},e.uniforms.iChannel0.value=M},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e,t.uniforms.iChannel0.value=M}};const L=String.raw;let N={uniforms:Object.assign({},_),vertexShader:{},fragmentShader:{uniforms:S,functions:L`
        ...
        void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
            ...
            `,replaceMap:C},init:function(e){},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e}};const P=String.raw;let H={uniforms:Object.assign({},_),vertexShader:{},fragmentShader:{uniforms:S,functions:P`
      //// COLORS ////
      ...
      `,replaceMap:C},init:function(e){e.uniforms.texRepeat={value:e.map.repeat},e.uniforms.texOffset={value:new THREE.Vector2(e.map.offset.x+Math.random(),e.map.offset.x+Math.random())},e.uniforms.texFlipY={value:e.map.flipY?1:0},e.userData.timeOffset=10*Math.random()},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e+t.userData.timeOffset}};var k={uniforms:"insertbefore:#include <common>\n",functions:"insertafter:#include <clipping_planes_pars_vertex>\n",preTransform:"insertafter:#include <begin_vertex>\n",postTransform:"insertafter:#include <project_vertex>\n",preNormal:"insertafter:#include <beginnormal_vertex>\n"},z={uniforms:"insertbefore:#include <common>\n",functions:"insertafter:#include <clipping_planes_pars_fragment>\n",preFragColor:"insertbefore:gl_FragColor = vec4( outgoingLight, diffuseColor.a );\n",postFragColor:"insertafter:gl_FragColor = vec4( outgoingLight, diffuseColor.a );\n",postMap:"insertafter:#include <map_fragment>\n",replaceMap:"replace:#include <map_fragment>\n"};const O=(e,t,i)=>{let o;for(let a in t)i[a]&&(o=/insert(before):(.*)|insert(after):(.*)|(replace):(.*)/.exec(t[a]),o&&(o[1]?e=e.replace(o[2],i[a]+"\n"+o[2]):o[3]?e=e.replace(o[4],o[4]+"\n"+i[a]):o[5]&&(e=e.replace(o[6],i[a]))));return e},F=e=>{let t={};for(let i in e)t[i]=Object.assign({},e[i]);return t};let j={MeshStandardMaterial:"standard",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshDepthMaterial:"depth",standard:"standard",basic:"basic",lambert:"lambert",phong:"phong",depth:"depth"},I=null;const U=e=>{if(!I){let e={standard:THREE.MeshStandardMaterial,basic:THREE.MeshBasicMaterial,lambert:THREE.MeshLambertMaterial,phong:THREE.MeshPhongMaterial,depth:THREE.MeshDepthMaterial};I={};for(let t in e)I[t]={ShaderClass:e[t],ShaderLib:THREE.ShaderLib[t],Key:t,Count:0,ModifiedName:function(){return`ModifiedMesh${this.Key[0].toUpperCase()+this.Key.slice(1)}Material_${++this.Count}`},TypeCheck:`isMesh${t[0].toUpperCase()+t.slice(1)}Material`}}let t;if("function"==typeof e){for(let i in I)if(I[i].ShaderClass===e){t=I[i];break}}else{t=I[j[e]||e]}if(!t)throw new Error("No Shader found to modify...");return t};var V=new class{constructor(e,t){this._vertexHooks={},this._fragmentHooks={},e&&this.defineVertexHooks(e),t&&this.defineFragmentHooks(t)}modify(e,t){let i=U(e);return{vertexShader:O(i.ShaderLib.vertexShader,this._vertexHooks,t.vertexShader||{}),fragmentShader:O(i.ShaderLib.fragmentShader,this._fragmentHooks,t.fragmentShader||{}),uniforms:Object.assign({},i.ShaderLib.uniforms,t.uniforms||{})}}extend(e,t){let i=U(e),o=O(i.ShaderLib.vertexShader,this._vertexHooks,t.vertexShader||{}),a=O(i.ShaderLib.fragmentShader,this._fragmentHooks,t.fragmentShader||{}),r=Object.assign({},i.ShaderLib.uniforms,t.uniforms||{}),n=t.className||i.ModifiedName(),s=new Function("BaseClass","uniforms","vertexShader","fragmentShader","cloneUniforms",`\n\n            var cls = function ${n}( params ){\n\n                BaseClass.call( this, params );\n\n                this.uniforms = cloneUniforms( uniforms );\n\n                this.vertexShader = vertexShader;\n                this.fragmentShader = fragmentShader;\n                this.type = '${n}';\n\n                this.setValues( params );\n\n            }\n\n            cls.prototype = Object.create( BaseClass.prototype );\n            cls.prototype.constructor = cls;\n            cls.prototype.${i.TypeCheck} = true;\n\n            cls.prototype.copy = function( source ){\n\n                BaseClass.prototype.copy.call( this, source );\n\n                this.uniforms = Object.assign( {}, source.uniforms );\n                this.vertexShader = vertexShader;\n                this.fragmentShader = fragmentShader;\n                this.type = '${n}';\n\n                return this;\n\n            }\n\n            return cls;\n\n        `);return t.postModifyVertexShader&&(o=t.postModifyVertexShader(o)),t.postModifyFragmentShader&&(a=t.postModifyFragmentShader(a)),s(i.ShaderClass,r,o,a,F)}defineVertexHooks(e){for(let t in e)this._vertexHooks[t]=e[t]}defineFragmentHooks(e){for(let t in e)this._fragmentHooks[t]=e[t]}}(k,z);const q=String.raw,B=Object.assign({},_,{iChannel0:{value:null}}),Y=new THREE.TextureLoader;var X=null;Y.load("https://resources.realitymedia.digital/data/images/small-noise.png",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,X=e}));let W={uniforms:B,vertexShader:{},fragmentShader:{uniforms:S+q`
      uniform sampler2D iChannel0;
        `,functions:q`
        //CBS
       ...
       `,replaceMap:C},init:function(e){e.uniforms.texRepeat={value:e.map.repeat},e.uniforms.texOffset={value:e.map.offset},e.uniforms.texFlipY={value:e.map.flipY?1:0},e.uniforms.iChannel0.value=X,e.userData.timeOffset=1e5*Math.random()},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e+t.userData.timeOffset,t.uniforms.iChannel0.value=X}};const G=String.raw,$=Object.assign({},_,{iChannel0:{value:null}}),Z=new THREE.TextureLoader;var K=null;Z.load("https://resources.realitymedia.digital/data/images/small-noise.png",(e=>{e.minFilter=THREE.NearestFilter,e.magFilter=THREE.NearestFilter,e.wrapS=THREE.RepeatWrapping,e.wrapT=THREE.RepeatWrapping,K=e}));let J={uniforms:$,vertexShader:{},fragmentShader:{uniforms:S+G`
      uniform sampler2D iChannel0;
        `,functions:G`
       ...
       `,replaceMap:C},init:function(e){e.uniforms.texRepeat={value:e.map.repeat},e.uniforms.texOffset={value:e.map.offset},e.uniforms.texFlipY={value:e.map.flipY?1:0},e.uniforms.iChannel0.value=K,e.userData.timeOffset=10*Math.random()},updateUniforms:function(e,t){t.uniforms.iTime.value=.001*e+t.userData.timeOffset,t.uniforms.iChannel0.value=K}};const Q=String.raw;let ee={uniforms:Object.assign({},_),vertexShader:{},fragmentShader:{uniforms:S,functions:Q`
    ...
    `,replaceMap:C},init:function(e){e.uniforms.texRepeat={value:e.map.repeat},e.uniforms.texOffset={value:e.map.offset},e.uniforms.texFlipY={value:e.map.flipY?1:0},e.userData.timeOffset=10*Math.random()},updateUniforms:function(e,t){t.uniforms.iTime.value=.0012*e+t.userData.timeOffset}};const te=String.raw,ie={animate:!1,noiseMode:"scale",invert:!1,sharpen:!0,scaleByPrev:!1,gain:.54,lacunarity:2,octaves:5,scale1:3,scale2:3,timeScaleX:.4,timeScaleY:.3,color1:[0,0,0],color2:[130,129,129],color3:[110,110,110],color4:[82,51,13],offsetAX:0,offsetAY:0,offsetBX:3.7,offsetBY:.9,offsetCX:2.1,offsetCY:3.2,offsetDX:4.3,offsetDY:2.8,offsetX:0,offsetY:0};let oe={uniforms:{mb_animate:{value:ie.animate},mb_color1:{value:ie.color1.map((e=>e/255))},mb_color2:{value:ie.color2.map((e=>e/255))},mb_color3:{value:ie.color3.map((e=>e/255))},mb_color4:{value:ie.color4.map((e=>e/255))},mb_gain:{value:ie.gain},mb_invert:{value:ie.invert},mb_lacunarity:{value:ie.lacunarity},mb_noiseMode:{value:0},mb_octaves:{value:ie.octaves},mb_offset:{value:[ie.offsetX,ie.offsetY]},mb_offsetA:{value:[ie.offsetAX,ie.offsetAY]},mb_offsetB:{value:[ie.offsetBX,ie.offsetBY]},mb_offsetC:{value:[ie.offsetCX,ie.offsetCY]},mb_offsetD:{value:[ie.offsetDX,ie.offsetDY]},mb_scale1:{value:ie.scale1},mb_scale2:{value:ie.scale2},mb_scaleByPrev:{value:ie.scaleByPrev},mb_sharpen:{value:ie.sharpen},mb_time:{value:0},mb_timeScale:{value:[ie.timeScaleX,ie.timeScaleY]},texRepeat:{value:new THREE.Vector2(1,1)},texOffset:{value:new THREE.Vector2(0,0)}},vertexShader:{},fragmentShader:{uniforms:te`
